...
- (CAShapeLayer *)outterLayer
{
    if (_outterLayer==nil) {
        ...
        _outterLayer.frame = CGRectMake( (self.frame.size.width-outter)/2 , (self.frame.size.width-outter)/2 , outter , outter);
        _outterLayer.fillColor = BACKGROUNDCOLOR.CGColor;
//        _outterLayer.strokeColor = [UIColor whiteColor].CGColor;
        _outterLayer.strokeColor = RGBA(251, 87, 42, 1.0).CGColor;
...
//    self.outterLayer.strokeColor = [UIColor whiteColor].CGColor;
    self.outterLayer.strokeColor = RGBA(251, 87, 42, 1.0).CGColor;
}
