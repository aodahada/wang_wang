...
//        _tfLabel.textColor = [UIColor whiteColor];
        _tfLabel.textColor = RGBA(251, 87, 42, 1.0);
...
//    self.tfLabel.textColor = [UIColor whiteColor];
    self.tfLabel.textColor = RGBA(251, 87, 42, 1.0);
...
//    BOOL isSaveBool = [KeychainData isFirstInput:resultStr];
    BOOL isSaveBool = [[SingletonManager sharedManager] isFirstInput:resultStr];
...
//        BOOL isRight = [KeychainData isSecondInputRight:resultStr];
        BOOL isRight = [[SingletonManager sharedManager] isSecondInputRight:resultStr];
        if (isRight) {
            // 验证成功
...
//        BOOL isValidate = [KeychainData isSecondInputRight:resultStr];
        BOOL isValidate = [[SingletonManager sharedManager] isSecondInputRight:resultStr];
        if (isValidate) {
