...
@interface ViewForNewYearProDetail ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation ViewForNewYearProDetail
...
- (void)setUpLayout {
    ...
    _tableView.backgroundColor = RGBA(255, 253, 231, 1.0);
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    cell.textLabel.textColor = RGBA(158, 100, 93, 1.0);
    cell.detailTextLabel.textColor = TITLE_COLOR;
    cell.backgroundColor = RGBA(255, 253, 231, 1.0);
    //    if (indexPath.row == 3) {
...
- (UIView *)tableView:(UITableView *)tableView viewForFooterInSection:(NSInteger)section {
    ...
    aView.backgroundColor = RGBA(255, 253, 231, 1.0);
    ...
    cdLable.textColor = RGBA(255, 253, 231, 1.0);
