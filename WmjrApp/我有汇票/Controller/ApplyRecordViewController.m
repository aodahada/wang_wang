    ...
    [manager postDataWithUrlActionStr:@"Bill/lists" withParamDictionary:@{@"member_id":[SingletonManager sharedManager].uid,@"status":status} withBlock:^(id obj) {
        if ([obj[@"result"] isEqualToString:@"1"]) {
            ...
            [_tableViewMain mas_updateConstraints:^(MASConstraintMaker *make) {
                make.height.mas_offset(RESIZE_UI(203+10)*_recordArray.count);
            }];
...
- (void)setUpLayout {
    ...
    //三个分类按钮的部分
    UIView *top3View = [[UIView alloc]init];
    top3View.backgroundColor = RGBA(0, 104, 178, 1.0);
    [viewMain addSubview:top3View];
    ...
    [top3View addSubview:_checkContinue];
    [_checkContinue mas_makeConstraints:^(MASConstraintMaker *make) {
        make.bottom.equalTo(top3View.mas_bottom).with.offset(-RESIZE_UI(20));
        make.height.mas_offset(RESIZE_UI(62));
        make.width.mas_offset(RESIZE_UI(47));
        make.left.equalTo(top3View.mas_left).with.offset(RESIZE_UI(48));
    }];
    ...
    [top3View addSubview:_checkContinueImageView];
    [_checkContinueImageView mas_makeConstraints:^(MASConstraintMaker *make) {
        make.bottom.equalTo(top3View.mas_bottom);
    ...
    [top3View addSubview:_checkPass];
    [_checkPass mas_makeConstraints:^(MASConstraintMaker *make) {
        make.centerX.equalTo(top3View.mas_centerX);
        make.bottom.equalTo(top3View.mas_bottom).with.offset(-RESIZE_UI(20));
    ...
    [top3View addSubview:_checkPassImageView];
    ...
    [top3View addSubview:_checkFail];
    [_checkFail mas_makeConstraints:^(MASConstraintMaker *make) {
        make.right.equalTo(top3View.mas_right).with.offset(-RESIZE_UI(41));
        make.bottom.equalTo(top3View.mas_bottom).with.offset(-RESIZE_UI(20));
        make.height.width.mas_offset(RESIZE_UI(62));
    }];
    ...
    [top3View addSubview:_checkFailImageView];
    ...
    [viewMain addSubview:_tableViewMain];
    [_tableViewMain mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.equalTo(top3View.mas_bottom);
        make.left.equalTo(viewMain.mas_left).with.offset(RESIZE_UI(5));
        make.right.equalTo(viewMain.mas_right).with.offset(-RESIZE_UI(5));
        make.height.mas_offset(RESIZE_UI(203+10)*_recordArray.count);
    }];
