...
//    NSString *imagePath = [[NSBundle mainBundle] pathForResource:@"wangmalogo" ofType:@"png"];
    NSString *imagePath = @"http://wmjr888.com/Public/Images/app_icon.png";
    ...
    switch (sender.tag) {
        ...
        {
            // 定制微信好友的分享内容
            [shareParams SSDKSetupWeChatParamsByText:content title:title url:[NSURL URLWithString:url] thumbImage:nil image:nil musicFileURL:nil extInfo:nil fileData:nil emoticonData:nil type:SSDKContentTypeAuto forPlatformSubType:SSDKPlatformSubTypeWechatSession];// 微信好友子平台
        ...
        {
            // 定制微信朋友圈的分享内容
            [shareParams SSDKSetupWeChatParamsByText:content title:title url:[NSURL URLWithString:url] thumbImage:nil image:nil musicFileURL:nil extInfo:nil fileData:nil emoticonData:nil type:SSDKContentTypeAuto forPlatformSubType:SSDKPlatformSubTypeWechatTimeline];// 微信好友子平台
